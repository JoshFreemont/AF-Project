...
void pacemaker(int* state_update_first_col, std::vector<int> &all_excited_coords, std::vector<int> &excitation_frame, const int &frame, const int& RP, const int& GRIDSIZE, std::pair<int,int>*excitedBy);
